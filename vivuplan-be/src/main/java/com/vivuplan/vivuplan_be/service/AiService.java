    ...
    private String buildCostAwarePrompt(TripDto.GenerateRequest req) {
        ...
        return String.format(
                """
                        ...
                        5. Do not reduce outdoor diversity just because there is RAIN FLEX or normal rain chance. Prefer safer timing, shorter windows, a concise backup note when useful, or moving signature experiences to a better day.
                        ...
                        10. Do not copy detailed forecast values or turn itinerary text into a forecast bulletin or blanket advisory. Natural activity-specific context such as "nếu thời tiết thuận" or a concise reminder to reconfirm route, site, water-level, sea, or operator conditions is allowed. If weather materially changes, substitutes, or blocks a user request or signature experience, explain that impact in requestFulfillment.items[].userMessage.
